...
public class Budget {
    ...
    @JsonProperty("lines")
    private List<@Valid BudgetLine> lines;
    ...
    public Budget(String budgetId, String name, Long fiscalYear, String fundId, Boolean active, String description, List<@Valid BudgetLine> lines, Extensions extensions) {
        super();
