...
public class OtherAssetItem {
    ...
    @DecimalMin("1")
    private Long paidReturnedOnLedgerRowIndex;
    ...
    public OtherAssetItem(String otherAssetItemId, LedgerLink ledgerLink, WorkbookLink workbookLink, String paidTo, Long year, String reason, OtherAssetItem.OtherAssetItemType type, OtherAssetItem.TypeCode typeCode, String eventBudgetLabel, String amountAsOfPriorYearEnd, Long paidReturnedOnLedgerRowIndex, LedgerLink settlementLedgerLink, OtherAssetItem.OtherAssetItemStatus status, Extensions extensions) {
        super();
    ...
    @JsonProperty("paidReturnedOnLedgerRowIndex")
    public Long getPaidReturnedOnLedgerRowIndex() {
        return paidReturnedOnLedgerRowIndex;
    }

    @JsonProperty("paidReturnedOnLedgerRowIndex")
    public void setPaidReturnedOnLedgerRowIndex(Long paidReturnedOnLedgerRowIndex) {
        this.paidReturnedOnLedgerRowIndex = paidReturnedOnLedgerRowIndex;
    }
