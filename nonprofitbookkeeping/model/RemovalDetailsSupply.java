...
public class RemovalDetailsSupply {
    ...
    private nonprofitbookkeeping.model.RemovalDetailsAsset.RemovalType removalType;
    ...
    public RemovalDetailsSupply(String approvedBy, String reason, Long numberRemoved, Boolean removed, nonprofitbookkeeping.model.RemovalDetailsAsset.RemovalType removalType) {
        super();
    ...
    @JsonProperty("removalType")
    public nonprofitbookkeeping.model.RemovalDetailsAsset.RemovalType getRemovalType() {
        return removalType;
    }

    @JsonProperty("removalType")
    public void setRemovalType(nonprofitbookkeeping.model.RemovalDetailsAsset.RemovalType removalType) {
        this.removalType = removalType;
    }
