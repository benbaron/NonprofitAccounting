...
public class SupplementalItem {
    ...
    public SupplementalItem(String supplementalItemId, SupplementalKind kind, String counterpartyName, String personId, Long year, String reason, String subtypeCode, String eventBudgetLabel, String budgetId, String sourceLabel, String amountAsOf, Long ledgerRowIndex, WorkbookLink workbookLink, Extensions extensions) {
        super();
    ...
    @JsonProperty("ledgerRowIndex")
    public Long getLedgerRowIndex() {
        return ledgerRowIndex;
    }

    @JsonProperty("ledgerRowIndex")
    public void setLedgerRowIndex(Long ledgerRowIndex) {
        this.ledgerRowIndex = ledgerRowIndex;
    }
