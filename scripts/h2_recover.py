...
def main() -> int:
    ...
    print("")
    print("If RunScript fails with a generated column error:")
    print("  - Edit the SQL to add 'OVERRIDING SYSTEM VALUE' after INSERT INTO for")
    print("    tables with identity/generated columns, or")
    print("  - Temporarily alter those columns to GENERATED BY DEFAULT before")
    print("    running the script, then restore the definition afterward.")
    print("  Example:")
    print('    INSERT INTO "PUBLIC"."COMPANY_STORE" OVERRIDING SYSTEM VALUE')
    print("    SELECT * FROM O_43;")
    print("")
    print("If RunScript fails with a PRIMARY KEY violation in INFORMATION_SCHEMA:")
    print("  - Import into a fresh database (delete the existing .mv.db files), or")
    print("  - Run a cleanup like: DROP ALL OBJECTS before re-importing.")
    return 0
