...
class ReportMetadataTest {
    ...
    void testConstructorAndGetters_withValidInputs() {
        ...
        assertEquals(created, metadata.getCreated(), "getCreated() should return the timestamp provided in constructor.");
        assertEquals(filePath, metadata.getFilePath(), "getFilePath() should return the path provided in constructor.");
    }
    ...
    void testConstructorAndGetters_withNullReportName() {
        ...
        assertNull(metadata.getReportName(), "getReportName() should return null if null was passed for reportName.");
    ...
    void testConstructorAndGetters_withNullCreated() {
        ...
        ReportMetadata metadata = new ReportMetadata(reportName, null, filePath);

        assertEquals(reportName, metadata.getReportName());
        assertNull(metadata.getCreated(), "getCreated() should return null if null was passed for created timestamp.");
        assertEquals(filePath, metadata.getFilePath());
    }
    ...
    void testConstructorAndGetters_withNullFilePath() {
        ...
        assertEquals(reportName, metadata.getReportName());
        assertEquals(created, metadata.getCreated());
        assertNull(metadata.getFilePath(), "getFilePath() should return null if null was passed for filePath.");
    }
    ...
    void testConstructorAndGetters_withAllNull() {
        ...
        assertNull(metadata.getReportName(), "getReportName() should be null if all inputs are null.");
        assertNull(metadata.getCreated(), "getCreated() should be null if all inputs are null.");
        assertNull(metadata.getFilePath(), "getFilePath() should be null if all inputs are null.");
    }
    ...
    void testConstructorAndGetters_withEmptyReportName() {
        ...
        assertEquals("", metadata.getReportName(), "getReportName() should return an empty string if an empty string was passed.");
        assertEquals(created, metadata.getCreated());
        assertEquals(filePath, metadata.getFilePath());
    }
    ...
    void testConstructorAndGetters_withEmptyCreated() {
        ...
        assertEquals(reportName, metadata.getReportName());
        assertEquals("", metadata.getCreated(), "getCreated() should return an empty string if an empty string was passed.");
        assertEquals(filePath, metadata.getFilePath());
    }
    ...
    void testConstructorAndGetters_withEmptyFilePath() {
        ...
        assertEquals(reportName, metadata.getReportName());
        assertEquals(created, metadata.getCreated());
        assertEquals("", metadata.getFilePath(), "getFilePath() should return an empty string if an empty string was passed.");
    }
    ...
    void testConstructorAndGetters_withAllEmpty() {
        ...
        assertEquals("", metadata.getReportName(), "getReportName() should be an empty string if all inputs are empty strings.");
        assertEquals("", metadata.getCreated(), "getCreated() should be an empty string if all inputs are empty strings.");
        assertEquals("", metadata.getFilePath(), "getFilePath() should be an empty string if all inputs are empty strings.");
    }
