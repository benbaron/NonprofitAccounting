...
class AbstractReportGeneratorTest
{
        ...
        @Test void resolveReportDataPrefersSuppliedBeans()
        {
                ...
                @SuppressWarnings("unchecked") List<Object> mutableView = (List<Object>) resolved;
        ...
        @Test void resolveReportDataHonoursExplicitEmptyList()
        {
                DummyGenerator generator = new DummyGenerator();
