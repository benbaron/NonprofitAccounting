...
public class BudgetEditorDialogFXTest extends JavaFXTestBase {
    ...
    public void testCreateMode_InitialStateAndFields() {
        ...
        TextField budgetNameField = lookup("#budgetNameField").queryTextField();
        Spinner<Integer> fiscalYearSpinner = lookup("#fiscalYearSpinner").querySpinner();
        ComboBox<Fund> fundComboBox = lookup("#applicableFundComboBox").queryComboBox();
        TextField currencyField = lookup("#currencyField").queryTextField();
    ...
    public void testEditMode_PopulatesFieldsFromExistingBudget() {
        ...
        assertEquals("Annual Operations", lookup("#budgetNameField").queryTextField().getText());
        assertEquals(2023, ((Spinner<Integer>)lookup("#fiscalYearSpinner").querySpinner()).getValue().intValue());
        assertEquals("Operational budget for 2023", lookup("#descriptionField").queryTextField().getText());
        assertEquals("USD", lookup("#currencyField").queryTextField().getText());
