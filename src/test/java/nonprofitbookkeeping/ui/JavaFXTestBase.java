...
import org.testfx.toolkit.setup.ToolkitSetup;

import java.util.concurrent.Semaphore;

import static org.testfx.toolkit.setup.ShowMode.SHOW;
...
public abstract class JavaFXTestBase extends ApplicationTest {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Parent emptyRoot = new Parent() {}; // An empty parent node
    ...
    @BeforeEach
    public void setupToolkit() throws Exception {
        ...
        System.setProperty("java.awt.headless", "false"); // Ensure AWT is not in headless mode for JavaFX

        // This is a workaround for potential issues with toolkit initialization in some environments
        // It ensures that the TestFX toolkit is ready before tests run.
        // ToolkitSetup.registerToolkit();
        // The above line might be needed if ApplicationTest doesn't handle it sufficiently
    }
