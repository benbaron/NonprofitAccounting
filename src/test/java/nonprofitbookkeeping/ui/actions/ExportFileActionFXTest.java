...
@ExtendWith(MockitoExtension.class) class ExportFileActionFXTest
{
		...
		void testHandle_basicCall_noUnexpectedExceptions()
	{
		...
		// This test can only verify that it doesn't crash immediately without a full FX
		// toolkit.
		// For a placeholder, we primarily test it doesn't throw NPEs due to its own
