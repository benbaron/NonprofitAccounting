...
public class GenerateReportsActionTest
{
        ...
        {
                TestableGenerateReportsAction action = new TestableGenerateReportsAction();

                java.awt.event.ActionEvent swingEvent = new java.awt.event.ActionEvent(this,
        ...
        private static final class TestableGenerateReportsAction extends GenerateReportsAction
        {
