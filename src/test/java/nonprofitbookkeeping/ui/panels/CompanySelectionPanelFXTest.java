...
@ExtendWith(MockitoExtension.class) class CompanySelectionPanelFXTest
{
	...
	@Test
	@DisplayName("Constructor: Null OnCompanyOpenedHandler should throw IllegalArgumentException") static
		...
		void testOpenSelected_fileSelectedConceptual_loadIOException_alertShown()
	{
		...
		this.currentCompanyMockedStatic.when(CurrentCompany::getCompany).thenReturn(null); // Ensure
																							// company
																							// is
																							// null
																							// after
