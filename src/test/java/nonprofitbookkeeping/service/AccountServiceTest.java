...
class AccountServiceTest {
    ...
    // --- addAccount() Tests ---
    @Test
    @DisplayName("addAccount: Valid account should be added successfully")
    ...
    void testGetAllAccounts_ensureReturnedListIsCopy() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> {
             // Collections.unmodifiableList() is not used, so direct modification would work on ArrayList copy.
    ...
    void testGetBalanceResults_withAccounts_shouldReturnCorrectAccountBalances() {
        ...
        assertTrue(balances.contains(new AccountBalance("B001", "Bal Account 1", new BigDecimal("100.50"))));
        assertTrue(balances.contains(new AccountBalance("B002", "Bal Account 2", new BigDecimal("-50.25"))));
        assertTrue(balances.contains(new AccountBalance("B003", "Zero Bal Account", BigDecimal.ZERO)));
        assertTrue(balances.contains(new AccountBalance("B004", "Null Bal Account", BigDecimal.ZERO)));
    }
