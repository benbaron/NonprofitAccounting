...
class InventoryServiceTest
{
	...
	{
		InventoryItem item =
			new InventoryItem("I001", "Test Item 1", BigDecimal.valueOf(100), "2023-01-01", 5);
	...
	{
		InventoryItem item1 =
			new InventoryItem("I001", "Original Item", BigDecimal.valueOf(100), "2023-01-01", 5);
		this.service.addItem(item1);
		InventoryItem item2 =
			new InventoryItem("I001", "Updated Item", BigDecimal.valueOf(120), "2023-02-01", 4);
		this.service.addItem(item2);
		assertEquals(1, this.service.listItems().size());
		assertEquals("Updated Item", this.service.listItems().get(0).getName());
		assertEquals(0,
			BigDecimal.valueOf(120).compareTo(this.service.listItems().get(0).getCost()));
	}
	...
	{
		InventoryItem item =
			new InventoryItem(null, "Test Item No ID", BigDecimal.valueOf(50), "2023-01-01", 5);
		this.service.addItem(item);
		assertEquals(0, this.service.listItems().size());
	}
	...
	{
		InventoryItem item1 =
			new InventoryItem("I001", "Item A", BigDecimal.valueOf(10), "2023-01-01", 5);
		InventoryItem item2 =
			new InventoryItem("I002", "Item B", BigDecimal.valueOf(20), "2023-01-01", 5);
		this.service.addItem(item1);
		this.service.addItem(item2);
	...
	{
		InventoryItem item1 =
			new InventoryItem("I001", "To Delete", BigDecimal.valueOf(10), "2023-01-01", 5);
		this.service.addItem(item1);
		assertEquals(1, this.service.listItems().size());
	...
	{
		InventoryItem item1 =
			new InventoryItem("I001", "Item", BigDecimal.valueOf(10), "2023-01-01", 5);
		this.service.addItem(item1);
		...
		void testUpdateItemExisting()
	{
		InventoryItem originalItem =
			new InventoryItem("U001", "Original Name", BigDecimal.valueOf(50), "2023-01-01", 5);
		this.service.addItem(originalItem);
		
		InventoryItem updatedItemInfo =
			new InventoryItem("U001", "Updated Name", BigDecimal.valueOf(75), "2023-02-02", 4);
		...
		assertEquals(0, BigDecimal.valueOf(75).compareTo(itemAfterUpdate.getCost()));
		assertEquals("2023-02-02", itemAfterUpdate.getAcquiredDate());
		assertEquals(4, itemAfterUpdate.getLifeYears());
		assertEquals(0,
			BigDecimal.valueOf(10).compareTo(itemAfterUpdate.getAccumulatedDepreciation()));
		assertEquals(0, BigDecimal.valueOf(0.15).compareTo(itemAfterUpdate.getDepreciationRate()));
	}
		...
		void testUpdateItemNonExistent()
	{
		InventoryItem itemToUpdate =
			new InventoryItem("U002", "Non Existent", BigDecimal.valueOf(50), "2023-01-01", 5);
	...
	{
		InventoryItem originalItem =
			new InventoryItem("U001", "Original", BigDecimal.valueOf(50), "2023-01-01", 5);
		this.service.addItem(originalItem);
		this.service.updateItem(null);
		assertEquals("Original", this.service.listItems().get(0).getName()); // Should remain
																				// unchanged
	}
		...
		void testUpdateItemNullId()
	{
		...
		this.service.addItem(originalItem);
		InventoryItem itemToUpdate =
			new InventoryItem(null, "Updated?", BigDecimal.valueOf(50), "2023-01-01", 5);
		this.service.updateItem(itemToUpdate);
		assertEquals("Original", this.service.listItems().get(0).getName()); // Should remain
																				// unchanged
	}
		...
		void testUpdateItemBlankId()
	{
		...
		this.service.addItem(originalItem);
		InventoryItem itemToUpdate =
			new InventoryItem(" ", "Updated?", BigDecimal.valueOf(50), "2023-01-01", 5);
		this.service.updateItem(itemToUpdate);
		assertEquals("Original", this.service.listItems().get(0).getName()); // Should remain
																				// unchanged
	}
	...
	{
		InventoryItem item1 =
			new InventoryItem("S001", "String Item 1", BigDecimal.valueOf(10.50), "2023-01-01", 5);
		InventoryItem item2 = new InventoryItem("S002", "String Item 2", null, "2023-01-01", 5); // Null
																									// cost
		this.service.addItem(item1);
		this.service.addItem(item2);
	...
	{
		InventoryItem item =
			new InventoryItem("D001", "No Dep", BigDecimal.valueOf(1000), "2023-01-01", 5);
	...
	{
		InventoryItem item =
			new InventoryItem("D002", "Dep Item", BigDecimal.valueOf(1000), "2023-01-01", 5);
		...
		assertEquals(0, BigDecimal.valueOf(100).compareTo(itemAfter.getAccumulatedDepreciation())); // 1000
																									// *
																									// 0.10
		assertNotNull(itemAfter.getNetValue());
		assertEquals(0, BigDecimal.valueOf(900).compareTo(itemAfter.getNetValue())); // 1000 - 100
		assertEquals(0, BigDecimal.valueOf(1000).compareTo(itemAfter.getCost())); // Original cost
																					// unchanged
	}
	...
	{
		InventoryItem item =
			new InventoryItem("D002_AD", "Dep Item AD", BigDecimal.valueOf(1000), "2023-01-01", 5);
		...
		InventoryItem itemAfter = this.service.listItems().get(0);
		assertEquals(0, BigDecimal.valueOf(150).compareTo(itemAfter.getAccumulatedDepreciation())); // 50
																									// +
																									// (1000
																									// *
																									// 0.10)
	...
	{
		InventoryItem item =
			new InventoryItem("D003", "Zero Rate Dep", BigDecimal.valueOf(1000), "2023-01-01", 5);
		item.setDepreciationRate(BigDecimal.ZERO);
		this.service.addItem(item);
		this.service.applyYearlyDepreciation();
		InventoryItem itemAfter = this.service.listItems().get(0);
		assertNull(itemAfter.getAccumulatedDepreciation()); // Or BigDecimal.ZERO if we want to
															// initialize it
		assertNull(itemAfter.getNetValue());
	}
	...
	{
		InventoryItem item =
			new InventoryItem("D005", "Multi Dep", BigDecimal.valueOf(1000), "2023-01-01", 5);
		item.setDepreciationRate(BigDecimal.valueOf(0.10));
		this.service.addItem(item);
		
		this.service.applyYearlyDepreciation(); // Year 1
		InventoryItem itemYear1 = this.service.listItems().get(0); // Re-fetch or ensure service
		...
		// To test on the *same instance* that's in the map, we need to update the item
		// in the map
		// or ensure applyYearlyDepreciation modifies the instance in the map directly
		// (which it does).
		this.service.applyYearlyDepreciation(); // Year 2
		InventoryItem itemYear2 = this.service.listItems().get(0);
		assertEquals(0, BigDecimal.valueOf(200).compareTo(itemYear2.getAccumulatedDepreciation())); // 100
																									// +
																									// (1000
																									// *
																									// 0.10)
	...
	{
		InventoryItem item =
			new InventoryItem("D007", "Null AccDep", BigDecimal.valueOf(1000), "2023-01-01", 5);
		item.setDepreciationRate(BigDecimal.valueOf(0.10));
		item.setAccumulatedDepreciation(null); // Explicitly set for test clarity, though it's
												// default
		this.service.addItem(item);
	...
	{
		InventoryItem item =
			new InventoryItem("D008", "Other Method", BigDecimal.valueOf(1000), "2023-01-01", 5);
		item.setDepreciationRate(BigDecimal.valueOf(0.10));
