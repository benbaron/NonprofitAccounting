...
class InventoryServiceTest {
    ...
    void testUpdateItemExisting() {
        ...
        assertEquals(0, BigDecimal.valueOf(10).compareTo(itemAfterUpdate.getAccumulatedDepreciation()));
    ...
    void testDepreciationNoRateMethod() {
        InventoryItem item = new InventoryItem("D001", "No Dep", BigDecimal.valueOf(1000), "2023-01-01", 5);
