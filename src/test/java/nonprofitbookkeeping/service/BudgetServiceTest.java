...
class BudgetServiceTest
{
		...
		void setUp()
	{
		...
		this.companyDirectory = this.tempDir.toFile(); // Use the temp directory as the company
														// directory
	}
...
>>>>>>> 734695e Add database persistence for budgets
		...
		void testLoadBudgets_NullCompanyDirectory() throws IOException
	{
		...
		assertTrue(loadedBudgets.isEmpty(),
			"Should return an empty list if company directory is null.");
	}
		...
		void testLoadBudgets_InvalidCompanyDirectory() throws IOException
	{
		...
		assertNotNull(loadedBudgets);
		assertTrue(loadedBudgets.isEmpty(),
			"Should return an empty list if company directory is not a directory.");
