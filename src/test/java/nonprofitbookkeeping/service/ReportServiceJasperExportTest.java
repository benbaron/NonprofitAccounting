...
class ReportServiceJasperExportTest
{
        ...
        void generateJasperReportExportsXlsxViaGenerator() throws Exception
        {
                ...
                Map<ReportService.ReportType, String> registry = Collections.singletonMap(
                ...
                context.setReportType(ReportService.ReportType.BALANCE_SHEET_JASPER.id());
                context.setOutputFormat("xlsx");

                File output =
                        service.generateJasperReport(context, context.getOutputFormat());

                assertNotNull(output, "Service should return the generated file instance.");
                assertTrue(output.exists(), "Stub generator should create the XLSX file on disk.");
        ...
        public static final class StubGenerator extends AbstractReportGenerator
        {
                ...
                @Override
                public File writeJasperOutput(String format, JasperPrint print, String baseName)
