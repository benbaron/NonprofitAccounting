...
public class PageViewerPanel extends JPanel {
    ...
    public void loadData(DefaultTableModel newModelData) {
        ...
        tableModel.setDataVector(newModelData.getDataVector(), newModelData.getColumnIdentifiers());
    ...
    public void displayInWindow(Component parentComponentForLocation, String title) {
        ...
        dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE); // Dispose on close to free resources
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            for (int i = 1; i <= 20; i++) {
                testModel.addRow(new Object[]{i, "Name " + i, Math.random() * 100});
            }
            ...
            // panel.displayInWindow(null, "Page Viewer Panel Test"); // Alternative using the method
            frame.pack();
