/**
 * nonprofit-scaledger-ribbon.zip_expanded TransactionService.java
 * TransactionService
 */
...
public class TransactionService
{
		...
		return allTransactions.stream()
			.filter(tx ->
			{
				...
				if (tx == null || tx.getAccount() == null ||
					tx.getAccount().getAccountNumber() == null)
				{
					return false;
				}
	...
	public static void addTransaction(AccountingTransaction tx)
	{
		...
		{ // Defensive check, though initialized at declaration
	...
	public static boolean removeTransaction(Long txId)
	{
		...
		return allTransactions.removeIf(tx -> tx != null &&
