...
// import com.fasterxml.jackson.databind.ObjectReader; // Commented out as ObjectReader r was removed
...
public class JacksonDataStorer implements DataStorer
{
        ...
        try (FileInputStream fis = new FileInputStream(file);
            ...
            while ((zipEntry = zis.getNextEntry()) != null) {
                if (JSON_ENTRY_NAME.equals(zipEntry.getName())) {
                    // System.out.println("loadData: Found entry 'company_data.json', attempting deserialization - START");
    ...
    @Override public void saveData(Object obj, File file) throws IOException, ActionCancelledException, NoFileCreatedException
    {
        ...
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream();
            ...
            // System.out.println("saveData: JSON serialization to ByteArrayOutputStream - START");
            this.mapper.writeValue(baos, obj);
            // System.out.println("saveData: JSON serialization to ByteArrayOutputStream - END");
            ...
            // System.out.println("saveData: Writing zip entry 'company_data.json' - START");
            zos.putNextEntry(zipEntry);
            // System.out.println("saveData: Writing zip entry 'company_data.json' - WRITING BYTES");
    ...
    @Override public List<File> listFiles(File directory, String extension)
    {
        ...
        List<File> result = Arrays.stream(directory.listFiles((dir, name) -> name.endsWith(extension)))
