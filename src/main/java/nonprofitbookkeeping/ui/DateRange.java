...
public final class DateRange
{
	 ...
	 *
	 * @param startInclusive start date (inclusive), nullable
	 * @param endInclusive end date (inclusive), nullable
	 */
	...
	{
		return this.startInclusive == null && this.endInclusive == null;
	}
