...
public class AlertBox
{
    ...
    /**
     * Obsolete message emitted by the legacy JVM shutdown save hook. The H2
     * database is already synchronized, and shutdown must not display a dialog.
     */
    private static final String OBSOLETE_SHUTDOWN_SAVE_MESSAGE =
    ...
    {
        if (OBSOLETE_SHUTDOWN_SAVE_MESSAGE.equals(message))
        {
            LOGGER.debug("Suppressing obsolete shutdown save warning");
            return;
        }
