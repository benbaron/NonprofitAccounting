...
public class TransactionEditorPanel implements AppPanel
{
	...
	private VBox buildSplitEditor()
	{
		...
		addLine.setOnAction(
			e -> splitTable.getItems().add(new SplitRow("", "", "", "", "", "", "")));
	...
	private record SplitRow(String account, String fund, String amount,
		String activity, String merchant, String nmr, String notes)
	{
	}
