...
public final class ThemeManager {
    ...
    private static final String LIGHT_CSS = ThemeManager.class.getResource("/themes/light.css").toExternalForm();
    private static final String DARK_CSS = ThemeManager.class.getResource("/themes/dark.css").toExternalForm();
