	...
	@Override public void actionPerformed(ActionEvent e)
	{
		...
		try
		{
			...
			Optional<ReportCriteria> criteriaOpt = ReportCriteriaDialog.showDialog(
				...
				availableFunds,
				DateSelectionMode.DATE_RANGE_OPTIONAL_START,
			...
			JOptionPane.showMessageDialog(null, "Trial Balance saved to: " + f.getAbsolutePath(),
		...
		catch (Exception ex)
		{
			...
			ex.printStackTrace();
			JOptionPane.showMessageDialog(null,
				"Failed to generate Trial Balance: " + ex.getMessage(), "Generation Error",
				JOptionPane.ERROR_MESSAGE);
		}
