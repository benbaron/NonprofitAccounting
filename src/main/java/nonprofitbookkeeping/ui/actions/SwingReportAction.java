...
public abstract class SwingReportAction extends AbstractAction
{
                ...
                String reportDisplayName)
        {
                ...
                this.reportDisplayName = Objects.requireNonNull(reportDisplayName, "reportDisplayName");
        }
        ...
        {
                String path = (output != null) ? output.getAbsolutePath() : "(unknown location)";
        ...
        protected void handleError(Exception ex)
        {
                String message = (ex != null && ex.getMessage() != null)
                        ? ex.getMessage()
                        : "Unknown error";
                showDialog("Unable to generate " + this.reportDisplayName + " report: " + message,
        ...
        protected void showDialog(String message, int messageType)
        {
                ...
                {
                        JOptionPane.showMessageDialog(null, message, "Reports", messageType);
                }
                else
                {
