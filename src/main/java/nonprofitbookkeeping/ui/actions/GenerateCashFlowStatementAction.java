...
/**
 * JavaFX action handler for generating a Cash Flow Statement report.
...
public class GenerateCashFlowStatementAction extends AbstractAction  implements EventHandler<ActionEvent> {
    ...
    // private static final long serialVersionUID = 1L; // Not needed for JavaFX EventHandler
    ...
    public GenerateCashFlowStatementAction(ReportService reportService) {
        // super("Generate Cash Flow Statement"); // Constructor for AbstractAction, not used for JavaFX
    ...
    public void handle(ActionEvent event) {
        ...
        try {
            ...
            LocalDate startDate = criteria.getStartDate(); // Dialog ensures this is not null for DATE_RANGE_MANDATORY_START
