...
public class GenerateBalanceSheetAction extends AbstractAction implements EventHandler<ActionEvent> {
    ...
    public GenerateBalanceSheetAction(ReportService reportService) {
        // super("Generate Balance Sheet"); // Constructor for AbstractAction, not used for JavaFX EventHandler
    ...
    public void handle(ActionEvent event) {
        ...
        try {
            ...
            List<Fund> availableFunds = new ArrayList<>(); // Placeholder, as actual fund list isn't directly passed to dialog here
            ...
            Optional<ReportCriteria> criteriaOpt = ReportCriteriaDialog.showDialog(
                    ...
                    null, // chartOfAccounts not needed for this specific dialog call variant for Balance Sheet
            ...
            LocalDate endDate = criteria.getEndDate(); // Dialog ensures this is not null for SINGLE_DATE mode
            ...
            if (configNameToSave != null && !configNameToSave.trim().isEmpty()) {
                ...
                if (companyDir != null) {
                    ReportConfiguration newConfig = new ReportConfiguration(
                            ...
                            criteria.getStartDate(), // Will be null for SINGLE_DATE mode from dialog typically
                            endDate,
                            selectedFundIds);
        ...
        } catch (Exception ex) { // General catch for other errors during report generation
