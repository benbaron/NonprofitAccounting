...
public class GenerateIncomeStatementAction implements EventHandler<ActionEvent> {

    // private static final long serialVersionUID = -6004544138078222664L; // Removed
    ...
    public GenerateIncomeStatementAction(ReportService reportService) {
        // super("Generate Income Statement"); // Removed
    ...
    public void handle(ActionEvent event) {
        ...
        try {
            ...
            ex.printStackTrace();
            AlertBox.showError(parentWindow,
                    "Failed to generate Income Statement: " + ex.getMessage());
        }
    }
}
