...
{
        private static final DateTimeFormatter FISCAL_YEAR_FORMATTER =
        ...
        /**
         * Retrieves the default report year.
         *
         * @return the report year to use when the fiscal year preset is selected.
         */
        ...
        /**
         * Updates the default report year.
         *
         * @param defaultReportYear the report year to use when the fiscal year preset is selected.
         */
        ...
        public MonthDay getFiscalYearStartMonthDay()
        {
                ...
                try
                {
                        return MonthDay.parse(this.fiscalYearStart, FISCAL_YEAR_FORMATTER);
                }
