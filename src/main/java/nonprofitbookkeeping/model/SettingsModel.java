...
public class SettingsModel
{
        ...
        /**
         * Returns the optional default report year.
         *
         * @return configured default report year or {@code null} when not set.
         */
        ...
        /**
         * Updates the default report year used for fiscal year reporting.
         *
         * @param defaultReportYear the calendar year to use, or {@code null} to clear the value.
         */
