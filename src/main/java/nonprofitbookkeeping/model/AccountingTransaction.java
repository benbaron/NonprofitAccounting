...
public class AccountingTransaction implements Serializable {
	...
	public AccountingTransaction(Account account, Set<AccountingEntry> entries,
		...
		this.account = com.google.common.base.Preconditions.checkNotNull(account, "account cannot be null");
		// Temporarily assign to a modifiable collection
		Set<nonprofitbookkeeping.model.AccountingEntry> modifiableEntries = new java.util.HashSet<>(com.google.common.base.Preconditions.checkNotNull(entries, "entries cannot be null"));
		if (modifiableEntries != null) { // Though checkNotNull above handles entries being null
	...
	public String toString() {
		...
		sb.append("Transaction ").append(Instant.ofEpochMilli(this.bookingDateTimestamp).toString()).append("\n");
