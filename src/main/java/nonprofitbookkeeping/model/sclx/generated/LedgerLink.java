...
public class LedgerLink {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LedgerLink) == false) {
            return false;
        }
        LedgerLink rhs = ((LedgerLink) other);
        return (((this.lineId == rhs.lineId)||((this.lineId!= null)&&this.lineId.equals(rhs.lineId)))&&((this.transactionId == rhs.transactionId)||((this.transactionId!= null)&&this.transactionId.equals(rhs.transactionId))));
    }
