...
public class WorkbookLink {
    ...
    public int hashCode() {
        int result = 1;
        result = ((result* 31)+((this.sheetKey == null)? 0 :this.sheetKey.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WorkbookLink) == false) {
            return false;
        }
        WorkbookLink rhs = ((WorkbookLink) other);
        return (((this.sheetKey == rhs.sheetKey)||((this.sheetKey!= null)&&this.sheetKey.equals(rhs.sheetKey)))&&((this.ledgerRowIndex == rhs.ledgerRowIndex)||((this.ledgerRowIndex!= null)&&this.ledgerRowIndex.equals(rhs.ledgerRowIndex))));
    }
