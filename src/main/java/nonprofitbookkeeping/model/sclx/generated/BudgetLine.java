...
public class BudgetLine {
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.expenseCategory == null)? 0 :this.expenseCategory.hashCode()));
        result = ((result* 31)+((this.eventName == null)? 0 :this.eventName.hashCode()));
        result = ((result* 31)+((this.revenueCategory == null)? 0 :this.revenueCategory.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BudgetLine) == false) {
            return false;
        }
        BudgetLine rhs = ((BudgetLine) other);
        return ((((((((this.accountId == rhs.accountId)||((this.accountId!= null)&&this.accountId.equals(rhs.accountId)))&&((this.extensions == rhs.extensions)||((this.extensions!= null)&&this.extensions.equals(rhs.extensions))))&&((this.notes == rhs.notes)||((this.notes!= null)&&this.notes.equals(rhs.notes))))&&((this.expenseCategory == rhs.expenseCategory)||((this.expenseCategory!= null)&&this.expenseCategory.equals(rhs.expenseCategory))))&&((this.eventName == rhs.eventName)||((this.eventName!= null)&&this.eventName.equals(rhs.eventName))))&&((this.revenueCategory == rhs.revenueCategory)||((this.revenueCategory!= null)&&this.revenueCategory.equals(rhs.revenueCategory))))&&((this.budgetedAmount == rhs.budgetedAmount)||((this.budgetedAmount!= null)&&this.budgetedAmount.equals(rhs.budgetedAmount))));
    }
