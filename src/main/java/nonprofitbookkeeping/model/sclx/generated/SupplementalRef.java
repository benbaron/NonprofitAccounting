...
public class SupplementalRef {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SupplementalRef) == false) {
            return false;
        }
        SupplementalRef rhs = ((SupplementalRef) other);
        return (((this.recordId == rhs.recordId)||((this.recordId!= null)&&this.recordId.equals(rhs.recordId)))&&((this.recordType == rhs.recordType)||((this.recordType!= null)&&this.recordType.equals(rhs.recordType))));
    }
