...
public class Approval {
    ...
    public int hashCode() {
        int result = 1;
        result = ((result* 31)+((this.policyRequired == null)? 0 :this.policyRequired.hashCode()));
        result = ((result* 31)+((this.extensions == null)? 0 :this.extensions.hashCode()));
        result = ((result* 31)+((this.committeeApprovalRef == null)? 0 :this.committeeApprovalRef.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((this.policyRequired == rhs.policyRequired)||((this.policyRequired!= null)&&this.policyRequired.equals(rhs.policyRequired)))&&((this.extensions == rhs.extensions)||((this.extensions!= null)&&this.extensions.equals(rhs.extensions))))&&((this.committeeApprovalRef == rhs.committeeApprovalRef)||((this.committeeApprovalRef!= null)&&this.committeeApprovalRef.equals(rhs.committeeApprovalRef))))&&((this.approvalDate == rhs.approvalDate)||((this.approvalDate!= null)&&this.approvalDate.equals(rhs.approvalDate))))&&((this.notes == rhs.notes)||((this.notes!= null)&&this.notes.equals(rhs.notes))))&&((this.approvedBy == rhs.approvedBy)||((this.approvedBy!= null)&&this.approvedBy.equals(rhs.approvedBy))));
    }
