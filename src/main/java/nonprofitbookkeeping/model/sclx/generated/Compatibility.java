...
public class Compatibility {
    ...
    public int hashCode() {
        int result = 1;
        result = ((result* 31)+((this.minimumReaderVersion == null)? 0 :this.minimumReaderVersion.hashCode()));
        result = ((result* 31)+((this.lossyDowngradeTo == null)? 0 :this.lossyDowngradeTo.hashCode()));
        return result;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Compatibility) == false) {
            return false;
        }
        Compatibility rhs = ((Compatibility) other);
        return (((this.minimumReaderVersion == rhs.minimumReaderVersion)||((this.minimumReaderVersion!= null)&&this.minimumReaderVersion.equals(rhs.minimumReaderVersion)))&&((this.lossyDowngradeTo == rhs.lossyDowngradeTo)||((this.lossyDowngradeTo!= null)&&this.lossyDowngradeTo.equals(rhs.lossyDowngradeTo))));
    }
