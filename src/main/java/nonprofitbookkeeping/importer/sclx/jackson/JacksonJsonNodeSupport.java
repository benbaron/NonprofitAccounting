...
public final class JacksonJsonNodeSupport {
    ...
    public static Map<String, Object> objectMap(JsonNode node, String field, ObjectMapper mapper) {
        JsonNode child = node == null ? null : node.get(field);
    ...
    public static <E extends Enum<E>> E enumValue(JsonNode node, String field, Class<E> enumType) {
        String value = text(node, field);
        return value == null ? null : enumValue(value, enumType);
    }

    public static <E extends Enum<E>> E enumValue(String value, Class<E> enumType) {
