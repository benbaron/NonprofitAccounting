...
public class TransferOut10Binder
{
        ...
        private static List<TransferOutWithinKingdomRow> buildWithinRows()
        {
                ...
                list.add(new TransferOutWithinKingdomRow("Barony of Example", "Event advance", "1001", "2025-04-01", new BigDecimal("125.00")));
                return list;
        }
        ...
        private static List<TransferOutOutsideKingdomRow> buildOutsideRows()
        {
                ...
                list.add(new TransferOutOutsideKingdomRow("Atenveldt - Barony of Sun", "Prize reimbursement", "2002", "2025-04-15", new BigDecimal("75.00")));
                return list;
        }
        ...
        private static List<TransferOutScaOfficeRow> buildScaRows()
        {
                ...
                list.add(new TransferOutScaOfficeRow("Society Exchequer", "Quarterly tithe", "3003", "2025-05-01", new BigDecimal("50.00")));
                return list;
        }
                ...
                Collection<TransferOutScaOfficeRow> scaRows) throws Exception
        {
                ...
                BigDecimal withinTotal = sum(withinRows, TransferOutWithinKingdomRow::getAmount);
                BigDecimal outsideTotal = sum(outsideRows, TransferOutOutsideKingdomRow::getAmount);
                ...
                try (InputStream in = TransferOut10Binder.class.getResourceAsStream(jrxmlOnClasspath))
                {
        ...
        {
                String jrxml = "/jrxml/sca-reports/TRANSFER_OUT_10_AUTO_STYLED_fixed_labeled_-_Copy_rowbased.jrxml";
                ...
                JasperPrint print = fillTransferOut10(jrxml, "Sample Org", "Transfer Out Detail", within, outside, sca);
