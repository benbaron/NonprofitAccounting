...
public final class RowReports
{
	...
	/* ========================================================= 
	 * JRXML CLASSPATH CONSTANTS 
	 * Adjust these to match your resources layout.
	 * ========================================================= */
	public static final String JRXML_EXP_12A = "/reports/EXPENSE_DTL_12a_ROW_BASED.jrxml";
	public static final String JRXML_EXP_12B = "/reports/EXPENSE_DTL_12b_ROW_BASED.jrxml";
	public static final String JRXML_ASSET_5A = "/reports/ASSET_DTL_5a_ROW_BASED.jrxml";
	public static final String JRXML_LIAB_5B = "/reports/LIABILITY_DTL_5b_ROW_BASED.jrxml";
	public static final String JRXML_INV_6 = "/reports/INVENTORY_DTL_6_ROW_BASED.jrxml";
	public static final String JRXML_REG_7 = "/reports/REGALIA_SALES_DTL_7_ROW_BASED.jrxml";
	public static final String JRXML_DEPR_8 = "/reports/DEPR_DTL_8_ROW_BASED.jrxml";
	public static final String JRXML_TRIN_9 = "/reports/TRANSFER_IN_9_ROW_BASED.jrxml";
	public static final String JRXML_TROUT_10 = "/reports/TRANSFER_OUT_10_ROW_BASED.jrxml";
	public static final String JRXML_INC_11A = "/reports/INCOME_DTL_11a_ROW_BASED.jrxml";
	public static final String JRXML_INC_11B = "/reports/INCOME_DTL_11b_ROW_BASED.jrxml";
	public static final String JRXML_INC_11C = "/reports/INCOME_DTL_11c_ROW_BASED.jrxml";
	public static final String JRXML_INC_4 = "/reports/INCOME_4_ROW_BASED.jrxml";
	public static final String JRXML_FUNDS_14 = "/reports/FUNDS_14_ROW_BASED.jrxml";
	public static final String JRXML_NEWS_15 = "/reports/NEWSLETTER_15_ROW_BASED.jrxml";
	
	/* ========================================================= 
	 * GENERIC BINDING CORE 
	 * ========================================================= */
	...
	public static class TableSpec<T>
	{
		...
		private final Function<T, BigDecimal> amountGetter; // only needed if totalParamName
															// provided
		/**
		 * 
		...
		{
			this.rowsParamName = Objects.requireNonNull(rowsParamName, "rowsParamName");
									...
									Map<String, Object> extraParams) throws JRException
	{
		...
		try (InputStream in = RowReports.class.getResourceAsStream(jrxmlClasspath))
		{
			if (in == null)
				throw new JRException("JRXML not found on classpath: " + jrxmlClasspath);
		...
		{
			throw new JRException("Error loading/compiling " + jrxmlClasspath, e);
		}
	...
	/* ========================================================= 
	 * CONVENIENCE BUILDERS (BY REPORT) Replace bean type names 
	 * or getters to match your code.
	 * ========================================================= */
	
	// ---------- EXPENSE 12a ----------
	public static <A, B, C> JasperPrint 
		buildExpense12a(
		                String org,
		                String title,
		                ...
		                Function<C, BigDecimal> feeAmountGetter) throws JRException
	{
		return fill(JRXML_EXP_12A, org, title,
				Arrays.asList(
						...
						TableSpec.withTotal("P_EXP13_BADDEBTS_ROWS", badDebtRows, "P_TOTAL_13",
								badAmountGetter),
	...
	// ---------- EXPENSE 12b ----------
	public static <I, O, D> JasperPrint 
		buildExpense12b(
		                String org,
		                String title,
		                ...
		                Function<D, BigDecimal> donationAmountGetter) throws JRException
	{
		return fill(JRXML_EXP_12B, org, title,
				Arrays.asList(
						TableSpec.withTotal("P_EXP20_INSURANCE_ROWS", insuranceRows, "P_TOTAL_20",
								insAmountGetter),
						TableSpec.withTotal("P_EXP28_OTHER_ROWS", otherRows, "P_TOTAL_28",
								otherAmountGetter),
						TableSpec.withTotal("P_EXP29_DONATION_ROWS", donationRows, "P_TOTAL_29",
	...
	// ----------
	public static <D, P, L> JasperPrint 
		buildLiability5b(
		                 String org,
		                 String title,
		 ...
		 Function<T, BigDecimal> amountGetter) throws JRException
	{
		return fill(JRXML_INV_6, org, title,
				Collections.singletonList(
						TableSpec.withTotal("P_INVENTORY_ROWS", inventoryRows, "P_INVENTORY_TOTAL",
								amountGetter)),
				null);
		 ...
		 Function<K, BigDecimal> stockAmount) throws JRException
	{
		return fill(JRXML_REG_7, org, title,
				Arrays.asList(
						...
						TableSpec.withTotal("P_REGALIA_SALES_ROWS", salesRows, "P_TOTAL_SALES",
								salesAmount),
						TableSpec.withTotal("P_REGALIA_STOCK_ROWS", stockRows, "P_TOTAL_STOCK",
								stockAmount)),
				null);
		                   ...
		                   Function<T, BigDecimal> depr7yAmount) throws JRException
	{
		return fill(JRXML_DEPR_8, org, title,
				Arrays.asList(
						TableSpec.withTotal("P_DEPR_5Y_ROWS", depr5yRows, "P_DEPR_5Y_TOTAL",
								depr5yAmount),
						TableSpec.withTotal("P_DEPR_7Y_ROWS", depr7yRows, "P_DEPR_7Y_TOTAL",
								depr7yAmount)),
				null);
		                 ...
		                 Function<T, BigDecimal> amountGetter) throws JRException
	{
		return fill(JRXML_TRIN_9, org, title,
				Collections.singletonList(
						TableSpec.withTotal("P_TRANSFER_IN_ROWS", rows, "P_TOTAL_TRANSFER_IN",
								amountGetter)),
				null);
	...
	public static <T> JasperPrint buildTransferOut10
		(
		 ...
		 Collection<T> rows,
		 Function<T,
		 BigDecimal> amountGetter) throws JRException
	{
		return fill(JRXML_TROUT_10, org, title,
				Collections.singletonList(
						TableSpec.withTotal("P_TRANSFER_OUT_ROWS", rows, "P_TOTAL_TRANSFER_OUT",
								amountGetter)),
				null);
		 ...
		 Function<T, BigDecimal> amountGetter) throws JRException
	{
		return fill(JRXML_INC_11C, 
				org, 
				title,
				Collections.singletonList(TableSpec.withTotal("P_INCOME_11C_ROWS", rows, "P_TOTAL_11C",
						amountGetter)),
				null);
		 ...
		 BigDecimal> amountGetter) throws JRException
	{
		return fill(JRXML_INC_4, org, title,
				Collections.singletonList(
						TableSpec.withTotal("P_INCOME_ROWS", rows, "P_INCOME_TOTAL", amountGetter)),
				null);
	...
	public static <T> JasperPrint buildFunds14
		(
		 ...
		 Collection<T> rows,
		 Function<T,
		 BigDecimal> balanceGetter) throws JRException
	{
		return fill(JRXML_FUNDS_14, org, title,
				Collections.singletonList(
						TableSpec.withTotal("P_FUNDS_ROWS", rows, "P_FUNDS_TOTAL", balanceGetter)),
				null);
		 ...
		 BigDecimal> amountGetter) throws JRException
	{
		return fill(JRXML_NEWS_15, org, title,
				Collections.singletonList(
						TableSpec.withTotal("P_NEWSLETTER_ROWS", rows, "P_NEWSLETTER_TOTAL",
								amountGetter)),
				null);
	 ...
	 * EXPORT HELPERS
	 * ========================================================= */
	public static void exportPdf(JasperPrint jp, String outPath) throws JRException
	{
		JasperExportManager.exportReportToPdfFile(jp, outPath);
		
	}
	
	public static void exportHtml(JasperPrint jp, String outPath) throws JRException
	{
