...
public class TransferIn9Binder
{
        ...
        private static List<TransferInWithinKingdomRow> buildWithinRows()
        {
                ...
                list.add(new TransferInWithinKingdomRow("Barony of Example", "1234", "2025-01-15", new BigDecimal("150.00")));
                list.add(new TransferInWithinKingdomRow("Shire of Sample", "5678", "2025-02-10", new BigDecimal("200.00")));
                return list;
        }
        ...
        private static List<TransferInOutsideKingdomRow> buildOutsideRows()
        {
                ...
                list.add(new TransferInOutsideKingdomRow("Atenveldt - Barony of Sun", "9012", "2025-03-05", new BigDecimal("75.00")));
                return list;
        }
                ...
                Collection<TransferInOutsideKingdomRow> outsideRows) throws Exception
        {
                ...
                BigDecimal withinTotal = sum(withinRows, TransferInWithinKingdomRow::getAmount);
                BigDecimal outsideTotal = sum(outsideRows, TransferInOutsideKingdomRow::getAmount);
                ...
                try (InputStream in = TransferIn9Binder.class.getResourceAsStream(jrxmlOnClasspath))
                {
        ...
        {
                String jrxml = "/jrxml/sca-reports/TRANSFER_IN_9_AUTO_STYLED_fixed_labeled_rowbased.jrxml";
                List<TransferInWithinKingdomRow> within = buildWithinRows();
                List<TransferInOutsideKingdomRow> outside = buildOutsideRows();

                JasperPrint print = fillTransferIn9(jrxml, "Sample Org", "Transfer In Detail", within, outside);
