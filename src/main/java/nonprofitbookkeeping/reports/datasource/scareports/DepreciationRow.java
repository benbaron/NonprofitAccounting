...
public class DepreciationRow {
    ...
    public BigDecimal getPriorDepreciation() { return priorDepreciation; }
    public void setPriorDepreciation(BigDecimal priorDepreciation) { this.priorDepreciation = priorDepreciation; }

    public BigDecimal getDepreciationThisPeriod() { return depreciationThisPeriod; }
    public void setDepreciationThisPeriod(BigDecimal depreciationThisPeriod) { this.depreciationThisPeriod = depreciationThisPeriod; }
