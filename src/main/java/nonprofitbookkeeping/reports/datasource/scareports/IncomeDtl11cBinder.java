...
public class IncomeDtl11cBinder {
    ...
    private static List<DonationScaRow> buildScaRows() {
        return Arrays.asList(
                new DonationScaRow("Barony of Example", "General support", "", new BigDecimal("150.00")));
    }

    private static List<DonationNonScaRow> buildNonScaRows() {
        return Arrays.asList(
                new DonationNonScaRow("Local Business", "Sponsorship", "", new BigDecimal("80.00")));
    }
    ...
    public static JasperPrint fillIncome11c(String jrxmlOnClasspath,
        ...
        try (InputStream in = IncomeDtl11cBinder.class.getResourceAsStream(jrxmlOnClasspath)) {
    ...
    public static void main(String[] args) throws Exception {
        String jrxml = "/jrxml/sca-reports/INCOME_DTL_11c_AUTO_STYLED_fixed_-_Copy_rowbased.jrxml";
