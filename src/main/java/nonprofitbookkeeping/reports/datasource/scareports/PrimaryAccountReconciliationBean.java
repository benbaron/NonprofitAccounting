/**
 * NonprofitAccounting
 * PrimaryAccountReconciliationBean.java
...
public class PrimaryAccountReconciliationBean {
    ...
    private String accountEarnsInterest; // could be "YES"/"NO" or adapt to Boolean if you prefer
    ...
    public BigDecimal getBalanceFromBankStatement() { return balanceFromBankStatement; }
    public void setBalanceFromBankStatement(BigDecimal balanceFromBankStatement) { this.balanceFromBankStatement = balanceFromBankStatement; }

    public String getDeposit1Date() { return deposit1Date; }
    public void setDeposit1Date(String deposit1Date) { this.deposit1Date = deposit1Date; }

    public BigDecimal getDeposit1Amount() { return deposit1Amount; }
    public void setDeposit1Amount(BigDecimal deposit1Amount) { this.deposit1Amount = deposit1Amount; }

    // ... (other deposit/check getters & setters)

    public BigDecimal getEndingLedgerOrRegisterBalance() { return endingLedgerOrRegisterBalance; }
    public void setEndingLedgerOrRegisterBalance(BigDecimal endingLedgerOrRegisterBalance) {
        this.endingLedgerOrRegisterBalance = endingLedgerOrRegisterBalance;
    }

    public String getAccountEarnsInterest() { return accountEarnsInterest; }
    public void setAccountEarnsInterest(String accountEarnsInterest) { this.accountEarnsInterest = accountEarnsInterest; }

    public BigDecimal getDepositsNotClearedTotal() { return depositsNotClearedTotal; }
    ...
    public BigDecimal getChecksNotClearedTotal() { return checksNotClearedTotal; }
    public void setChecksNotClearedTotal(BigDecimal checksNotClearedTotal) {
        this.checksNotClearedTotal = checksNotClearedTotal;
    }

    public BigDecimal getAdjustedAccountBalance() { return adjustedAccountBalance; }
    ...
    public BigDecimal getReconciliationDifference() { return reconciliationDifference; }
