...
public class CashFlowStatementRowBean
{
	 ...
	 */
	public CashFlowStatementRowBean(String sectionName, String itemDescription,
		BigDecimal itemAmount, int sortOrder)
	{
	 ...
	 */
	public CashFlowStatementRowBean(String sectionName, String itemDescription,
		BigDecimal itemAmount, boolean isSubtotal, int sortOrder)
	{
