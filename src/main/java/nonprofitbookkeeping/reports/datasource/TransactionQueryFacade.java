...
public class TransactionQueryFacade
{
        ...
        private final List<Predicate<AccountingTransaction>> extraFilters = new ArrayList<>();
         ...
         * @return this facade for chaining
         */
        public TransactionQueryFacade addFilter(Predicate<AccountingTransaction> predicate)
        {
                if (predicate != null)
                {
