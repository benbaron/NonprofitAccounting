...
public class TransactionReportJasperGenerator extends AbstractReportGenerator
{
       ...
       @Override protected List<TransactionReportRowBean> getReportData()
       {
               ...
               List<nonprofitbookkeeping.model.AccountingTransaction> txns = company.getLedger().getTransactions();
               if (txns == null)
               {
                       return data;
               }
               ...
               for (nonprofitbookkeeping.model.AccountingTransaction tx : txns)
               {
                       ...
                       nonprofitbookkeeping.model.Account acct = company.getChartOfAccounts().getAccount(first.getAccountNumber());
                       ...
                       data.add(new TransactionReportRowBean(
                                       ...
                                       acct != null ? acct.getName() : first.getAccountNumber(),
                                       "",
                                       debit,
                                       credit));
               }
