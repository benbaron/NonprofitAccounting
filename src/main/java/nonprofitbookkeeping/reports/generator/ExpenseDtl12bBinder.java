...
public class ExpenseDtl12bBinder
{
	...
	private static List<InsuranceExpenseRow> buildInsuranceRows()
	{
		return Arrays.asList(
			new InsuranceExpenseRow("COI – Park Rental", "1001", "2025-02-01",
	...
	{
		return Arrays.asList(
			new DonationRow("501(c)(3) Partner", "123456",
				"Event proceeds donation", "2001", "2025-03-01",
		...
		Collection<DonationRow> donationRows) throws Exception
	{
		...
		try (InputStream in =
			ExpenseDtl12bBinder.class.getResourceAsStream(jrxmlOnClasspath))
		{
