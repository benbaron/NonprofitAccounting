    ...
    protected List<TRANSFER_OUT_10bBean> getReportData()
    {
        ...
        try
        {
            selectList = FieldMapSqlBuilder.buildSelectList(
                "/nonprofitbookkeeping/reports/TRANSFER_OUT_10b_fieldmap.csv",
                overrides
            );
        }
        catch (IOException ex)
        {
            throw new IllegalStateException(
                "Unable to load TRANSFER_OUT_10b field map", ex);
        }
        ...
        return ReportDataFetcher.queryBeans(TRANSFER_OUT_10bBean.class, sql);
    }
