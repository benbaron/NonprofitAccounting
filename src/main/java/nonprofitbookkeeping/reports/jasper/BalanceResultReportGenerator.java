...
public class BalanceResultReportGenerator extends AbstractReportGenerator
{
	...
	public BalanceResultReportGenerator(AccountService accountService)
	{
		...
		// methods
		// as getReportData() calls AccountService.getBalanceResults(Ledger)
		// statically.
	...
	protected Map<String, Object> getReportParameters()
	{
		...
		parameters.put("P_REPORT_TITLE", "Balance Result Report"); // Match
																	// typical
																	// JRXML
																	// param
																	// names
		...
		String companyDetailsText = "Company details not available."; // Default
																		// text
		...
		parameters.put("dateToday", LocalDate.now().toString()); // e.g.,
																	// "2024-01-15"
