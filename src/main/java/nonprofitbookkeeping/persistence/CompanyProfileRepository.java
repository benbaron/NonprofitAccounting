...
public class CompanyProfileRepository {
    ...
    public Optional<CompanyProfileModel> load() throws SQLException {
        try (Connection c = Database.get().getConnection();
            ...
            profile.setStartingBalanceDate(rs.getString("starting_balance_date"));
            profile.setChartOfAccountsType(rs.getString("chart_of_accounts_type"));
            ...
            profile.setEnableFundAccounting(rs.getBoolean("enable_fund_accounting"));
            profile.setEnableInventory(rs.getBoolean("enable_inventory"));
            profile.setEnableMultiCurrency(rs.getBoolean("enable_multi_currency"));
