...
public class CompanyRepository
{
	...
	public long create(Company company)
	{
		...
		{
			LOGGER.error("Failed to serialize company '{}' (id: {}).",
	...
	public Optional<Company> findById(long id)
	{
		...
		{
			Company company =
				mapper.readValue(entity.getJsonData(), Company.class);
	...
	public long count()
	{
		return entityManager
			.createQuery("SELECT COUNT(c) FROM CompanyEntity c", Long.class)
			.getSingleResult();
