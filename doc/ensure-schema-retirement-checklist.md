...
| `ensureFundTransferIntegrityArtifacts` | Adds stricter fund-transfer checks and indexes. | Flyway-owned target | Preserve these rules in migration scripts. Remove duplicate Java DDL once tests confirm. |
